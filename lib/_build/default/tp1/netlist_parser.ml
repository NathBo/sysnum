...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | NAND
    | NAME of (
# 27 "tp1/netlist_parser.mly"
       (string)
# 26 "tp1/netlist_parser.ml"
  )
    | MUX
    | INPUT
    | IN
    ...
    | EOF
    | CONST of (
# 26 "tp1/netlist_parser.mly"
       (string)
# 36 "tp1/netlist_parser.ml"
  )
    | CONCAT
    | COMMA
    | COLON
...
and ('s, 'r) _menhir_cell1_loption_separated_nonempty_list_COMMA_NAME__ = 
  | MenhirCell1_loption_separated_nonempty_list_COMMA_NAME__ of 's * ('s, 'r) _menhir_state * (string list)

and ('s, 'r) _menhir_cell1_loption_separated_nonempty_list_COMMA_var__ = 
  | MenhirCell1_loption_separated_nonempty_list_COMMA_var__ of 's * ('s, 'r) _menhir_state * ((string * Netlist_ast.ty) list)

and ('s, 'r) _menhir_cell1_var = 
  | MenhirCell1_var of 's * ('s, 'r) _menhir_state * (string * Netlist_ast.ty)
...
let _menhir_action_01 =
  fun n ->
    (
# 67 "tp1/netlist_parser.mly"
            ( Aconst (value_of_const n) )
# 327 "tp1/netlist_parser.ml"
     : (Netlist_ast.arg))

let _menhir_action_02 =
  fun id ->
    (
# 68 "tp1/netlist_parser.mly"
            ( Avar id )
# 335 "tp1/netlist_parser.ml"
     : (Netlist_ast.arg))

let _menhir_action_03 =
  fun e x ->
    (
# 44 "tp1/netlist_parser.mly"
                     ( (x, e) )
# 343 "tp1/netlist_parser.ml"
     : (Netlist_ast.equation))

let _menhir_action_04 =
  fun a ->
    (
# 47 "tp1/netlist_parser.mly"
          ( Earg a )
# 351 "tp1/netlist_parser.ml"
     : (Netlist_ast.exp))

let _menhir_action_05 =
  fun x ->
    (
# 48 "tp1/netlist_parser.mly"
              ( Enot x )
# 359 "tp1/netlist_parser.ml"
     : (Netlist_ast.exp))

let _menhir_action_06 =
  fun x ->
    (
# 49 "tp1/netlist_parser.mly"
               ( Ereg x )
# 367 "tp1/netlist_parser.ml"
     : (Netlist_ast.exp))

let _menhir_action_07 =
  fun x y ->
    (
# 50 "tp1/netlist_parser.mly"
                    ( Ebinop(And, x, y) )
# 375 "tp1/netlist_parser.ml"
     : (Netlist_ast.exp))

let _menhir_action_08 =
  fun x y ->
    (
# 51 "tp1/netlist_parser.mly"
                   ( Ebinop(Or, x, y) )
# 383 "tp1/netlist_parser.ml"
     : (Netlist_ast.exp))

let _menhir_action_09 =
  fun x y ->
    (
# 52 "tp1/netlist_parser.mly"
                     ( Ebinop(Nand, x, y) )
# 391 "tp1/netlist_parser.ml"
     : (Netlist_ast.exp))

let _menhir_action_10 =
  fun x y ->
    (
# 53 "tp1/netlist_parser.mly"
                    ( Ebinop(Xor, x, y) )
# 399 "tp1/netlist_parser.ml"
     : (Netlist_ast.exp))

let _menhir_action_11 =
  fun x y z ->
    (
# 54 "tp1/netlist_parser.mly"
                          ( Emux(x, y, z) )
# 407 "tp1/netlist_parser.ml"
     : (Netlist_ast.exp))

let _menhir_action_12 =
  fun addr ra word ->
    (
# 56 "tp1/netlist_parser.mly"
    ( Erom(addr, word, ra) )
# 415 "tp1/netlist_parser.ml"
     : (Netlist_ast.exp))

let _menhir_action_13 =
  fun addr data ra wa we word ->
    (
# 58 "tp1/netlist_parser.mly"
    ( Eram(addr, word, ra, we, wa, data) )
# 423 "tp1/netlist_parser.ml"
     : (Netlist_ast.exp))

let _menhir_action_14 =
  fun x y ->
    (
# 60 "tp1/netlist_parser.mly"
     ( Econcat(x, y) )
# 431 "tp1/netlist_parser.ml"
     : (Netlist_ast.exp))

let _menhir_action_15 =
  fun idx x ->
    (
# 62 "tp1/netlist_parser.mly"
     ( Eselect (idx, x) )
# 439 "tp1/netlist_parser.ml"
     : (Netlist_ast.exp))

let _menhir_action_16 =
  fun max min x ->
    (
# 64 "tp1/netlist_parser.mly"
     ( Eslice (min, max, x) )
# 447 "tp1/netlist_parser.ml"
     : (Netlist_ast.exp))

let _menhir_action_17 =
  fun c ->
    (
# 76 "tp1/netlist_parser.mly"
            ( int_of_string c )
# 455 "tp1/netlist_parser.ml"
     : (int))
...
# 229 "<standard.mly>"
    ( xs )
# 521 "tp1/netlist_parser.ml"
      
    in
    let inp = 
# 229 "<standard.mly>"
    ( xs )
# 527 "tp1/netlist_parser.ml"
     in
    (
# 41 "tp1/netlist_parser.mly"
    ( { p_eqs = eqs; p_vars = Env.of_list vars; p_inputs = inp; p_outputs = out; } )
# 532 "tp1/netlist_parser.ml"
     : (Netlist_ast.program))
...
# 240 "<standard.mly>"
    ( x :: xs )
# 564 "tp1/netlist_parser.ml"
     : ((string * Netlist_ast.ty) list))

let _menhir_action_29 =
  fun () ->
    (
# 72 "tp1/netlist_parser.mly"
              ( TBit )
# 572 "tp1/netlist_parser.ml"
     : (Netlist_ast.ty))

let _menhir_action_30 =
  fun n ->
    (
# 73 "tp1/netlist_parser.mly"
                ( TBitArray n )
# 580 "tp1/netlist_parser.ml"
     : (Netlist_ast.ty))

let _menhir_action_31 =
  fun ty x ->
    (
# 70 "tp1/netlist_parser.mly"
                      ( (x, ty) )
# 588 "tp1/netlist_parser.ml"
     : (string * Netlist_ast.ty))
